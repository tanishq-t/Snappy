  ...
  const handleSubmit = async (event) => {
    ...
    if (handleValidation()) {
      ...
      try {
        ...
        toast.error("User with username or email already exists!!", toastOptions);
      } finally {
        setIsLoading(false);
      }
    }
      ...
      <FormContainer>
        <FormWrapper>
          <BrandSection>
            ...
            <Subtitle>Create your account and start chatting</Subtitle>
          </BrandSection>
...
const InputField = styled.input`
  ...
  &[name="password"]:focus {
    border-color: ${props => {
      ...
      if (length < 4) return '#ef4444';
      if (length < 8) return '#f59e0b';
      return '#10b981';
    }};
  }
`;
